...
// Add wpadminbar functions for FIXED navigation
...
add_action('get_header','admin_bar_css');
...
//Add filters for Contact Form 7
...
function twentytwelve_setup() {
	...
	set_post_thumbnail_size( 730, 400 ); // Unlimited height, soft crop
	add_image_size( 'footer-thumb', 60, 60, array( 'center', 'center' ) ); // (cropped)
}
...
add_action('init', function(){
  ...
  if(is_wp_error($result)){
    ...
    //echo '<div id="message" class="error"><p>Wrong Password</p></div>';
