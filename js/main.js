...
jQuery(function() {
    ...
    var latitude = 1.343337,
        longitude = 103.775832,
        map_zoom = 16;

    //google map custom marker icon - .png fallback for IE11
    var is_internetExplorer11 = navigator.userAgent.toLowerCase().indexOf('trident') > -1;
    var marker_url = (is_internetExplorer11) ? 'wp-content/themes/hcf-2016/images/cd-icon-location.png' : 'wp-content/themes/hcf-2016/images/cd-icon-location.svg';

    //define the basic color of your map, plus a value for saturation and brightness
    var main_color = '#255AA8',
        saturation_value = -90,
        brightness_value = 8;
